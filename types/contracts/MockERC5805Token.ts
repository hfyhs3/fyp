...
export interface MockERC5805TokenInterface extends utils.Interface {
  functions: {
...
export interface MockERC5805Token extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MockERC5805TokenInterface;
